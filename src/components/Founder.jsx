                  ...
                  <div className="h-64 md:h-full bg-black relative overflow-hidden flex items-center justify-center">
                    <img
                      ...
                      onError={(e) => {
                        ...
                        e.target.src =
                          "https://placehold.co/800x800/000000/FFD700?text=No+Image";
                      }}
                      loading="lazy"
                    />
                ...
                <div className="p-8 md:w-3/5">
                  ...
                  <div className="mb-6">
                    <p className="text-gray-700 mb-4 font-roboto">
                      ...
                      {founder.title.toLowerCase()}. Their leadership has been
                      vital in steering the company’s success.
                    </p>
                    <p className="text-gray-700 font-roboto">
                      Their expertise in operational excellence and vision
                      continues to inspire the team and drive innovation.
                    </p>
                  </div>
