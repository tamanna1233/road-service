  ...
  if (!service) {
    return (
      <div className="container mx-auto px-4 py-16 text-center">
        ...
        <Link
          to="/"
          className="bg-yellow-400 text-black px-6 py-2 rounded-md font-semibold hover:bg-yellow-500 transition-colors"
        >
          Back to Services
        </Link>
      </div>
    ...
    <div className="bg-neutral-100 mi-h-screen">
      ...
      <div className="bg-white text-black relative">
        <div className="container mx-auto px-4 py-16 md:py-24">
          <Link
            to="/"
            className="inline-flex items-center mb-8 text-lg font-semibold  gap-4"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <ul className="space-y-3">
                {service.points
                  .slice(0, Math.ceil(service.points.length / 2))
                  .map((point, index) => (
            ...
            <div>
              <h4 className="text-xl font-semibold mb-4 md:hidden">
                Additional Features
              </h4>
              <ul className="space-y-3">
                {service.points
                  .slice(Math.ceil(service.points.length / 2))
                  .map((point, index) => (
                    <li key={index} className="flex items-start">
                      <span className="mr-2 mt-1 text-yellow-500">
                        <FaCheck />
          ...
          <div className="mt-10 pt-10 border-t border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-black text-white p-6 rounded-lg">
                ...
                <p>
                  We customize our approach to meet your specific needs, not
              ...
              <div className="bg-black text-white p-6 rounded-lg">
                ...
                <p>
                  Our commitment to your success means we're available whenever
                  you need us, providing continuous support.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="bg-black text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-8 max-w-2xl mx-auto">
            Get in touch with our {service.title} specialists today and discover
